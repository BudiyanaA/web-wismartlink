                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        ...
                                        <!-- GEDUNG -->
                                        <?php $data = $this->db->query('select menu.add from menu where id = 3')->row('add'); 
                                            if (in_array($this->session->userdata('level'), explode(',', $data))):
                                        ?>
                                        <a href="<?php echo base_url() ?>index.php/Gedung/create">
...
<script>
    $(document).ready(function() {
        ...
        $('#measurement').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('Gedung/get_data') ?>",
                "type": "POST"
            },
    ...
    function confirmDelete(no) {
        ...
        if (choice === true) {
            window.location.href = '<?= base_url(); ?>index.php/Gedung/delete/' + no;
        }
    }
</script>