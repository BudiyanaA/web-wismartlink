...
<script>
    $(document).ready(function() {
        ...
        $('#measurement').DataTable({
            ...
            "buttons": [
                ...
                {
                    "extend": 'pdf',
                    "messageTop": 'Level user',
                    "messageBottom": null
                },
                {
                    "extend": 'print',
                    "messageTop": 'Pengumuman',
                }
            ],
            ...
            "ajax": {
                "url": "<?php echo site_url('Level_user/get_data') ?>",
                "type": "POST"
            },
    ...
    function confirmDelete(no) {
        ...
        if (choice === true) {
            window.location.href = '<?= base_url(); ?>index.php/Level_user/delete/' + no;
        }
    }
</script>