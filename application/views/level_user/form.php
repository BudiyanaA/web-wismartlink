                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="level_name" id="title" class="form-control" placeholder="level_name" value="<?php echo $level_name ?>" <?php echo $disabled ?>> </div>
...
<script>
    function back() {
        window.location.href = "<?php echo base_url() ?>index.php/Level_user";
    }
</script>