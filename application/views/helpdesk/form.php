                        ...
                        <form role="form" method="post" action="<?php echo base_url() . $form_action ?>" enctype="multipart/form-data" onsubmit="$('#loading').show();$('.banners').hide()">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="nama" id="nama" class="form-control" placeholder="Nama" value="<?php echo $id_user ?>" <?php echo $disabled ?>> </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="nama" id="nama" class="form-control" placeholder="Nama" value="<?php echo $kode_tiket ?>" <?php echo $disabled ?>> </div>
                                <?php echo form_error('nama') ?>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="nama_apt" id="nama_apt" class="form-control" placeholder="Nama Apartemen" value="<?php echo $keterangan ?>" <?php echo $disabled ?>> </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="nama_apt" id="nama_apt" class="form-control" placeholder="Nama Apartemen" value="<?php echo $level?>" <?php echo $disabled ?>> </div>
                                <?php echo form_error('nama_apt') ?>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="nama_apt" id="nama_apt" class="form-control" placeholder="Nama Apartemen" value="<?php echo $pic_id ?>" <?php echo $disabled ?>> </div>
                                <?php echo form_error('nama_apt') ?>
                            </div>
...
<script>
    function back() {
        window.location.href = "<?php echo base_url() ?>index.php/Helpdesk";
    }
</script>