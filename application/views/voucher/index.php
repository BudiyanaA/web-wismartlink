                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        ...
                                        <!-- VOUCHER -->
                                        <?php $data = $this->db->query('select menu.add from menu where id = 28')->row('add'); 
...
<script>
    $(document).ready(function() {
        ...
        $('#measurement').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('Voucher/get_data') ?>",
                "type": "POST"
            },
    ...
    function confirmDelete(no) {
        ...
        if (choice === true) {
            window.location.href = '<?= base_url(); ?>index.php/Voucher/delete/' + no;
        }
    }
</script>