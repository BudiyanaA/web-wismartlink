                        ...
                        <form role="form" method="post" action="<?php echo base_url() . $form_action ?>" enctype="multipart/form-data" onsubmit="$('#loading').show();$('.banners').hide()">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="invoice_date" id="invoice_date" class="form-control" placeholder="Tanggal" value="<?php echo $invoice_date ?>" <?php echo $disabled ?>> </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    ?>
                                    <input type="text" name="is_paid" id="is_paid" class="form-control" placeholder="Status" value="<?php echo $lunas ?>" <?php echo $disabled ?>> </div>
