...
<script>
    $(document).ready(function() {
        ...
        $('#measurement').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('Toko/get_data') ?>",
                "type": "POST"
            },
    ...
    function confirmDelete(no) {
        var choice = confirm('Apakah Anda ingin mencetak Toko ?');
        if (choice === true) {
            window.location.href = '<?= base_url(); ?>index.php/Toko/cetak/' + no;
        }
    }

    function approve(no) {
        var choice = confirm('Approve toko ini?');
        if (choice === true) {
            window.location.href = '<?= base_url(); ?>index.php/Toko/approve/' + no;
        }
    }
</script>