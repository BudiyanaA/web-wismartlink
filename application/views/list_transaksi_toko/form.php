                        ...
                        <form role="form" method="post" action="<?php echo base_url() . $form_action ?>" enctype="multipart/form-data" onsubmit="$('#loading').show();$('.banners').hide()">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="nama" id="nama" class="form-control" placeholder="Nama" value="<?php echo $nama_toko ?>" <?php echo $disabled ?>> </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="nama_barang" id="nama_barang" class="form-control" placeholder="Nama" value="<?php echo $nama_barang ?>" <?php echo $disabled ?>> </div>
                                <?php echo form_error('nama') ?>
                            </div>
                            <div class="form-group">
                                <label> Harga</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="nama_barang" id="nama_barang" class="form-control" placeholder="Nama" value="<?php echo $jumlah_barang ?>" <?php echo $disabled ?>> </div>
                                <?php echo form_error('nama') ?>
                            </div>
                            <div class="form-group">
...
<script>
    function back() {
        window.location.href = "<?php echo base_url() ?>index.php/List_transaksi_toko";
    }
</script>