                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="<?php echo base_url() ?>index.php/Notifikasi/create">
...
<script>
    $(document).ready(function() {
        ...
        $('#measurement').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('Notifikasi/get_data') ?>",
                "type": "POST"
            },
    ...
    function confirmDelete(no) {
        ...
        if (choice === true) {
            window.location.href = '<?= base_url(); ?>index.php/Notifikasi/delete/' + no;
        }
    }

    function send(no) {
        var choice = confirm('Apakah Anda ingin mengirim notifikasi ini ?');
        if (choice === true) {
            window.location.href = '<?= base_url(); ?>index.php/Notifikasi/send/' + no;
        }
    }
</script>