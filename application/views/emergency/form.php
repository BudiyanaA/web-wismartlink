                        ...
                        <form role="form" method="post" action="<?php echo base_url() . $form_action ?>" enctype="multipart/form-data" onsubmit="$('#loading').show();$('.banners').hide()">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="insert_date" id="insert_date" class="form-control" placeholder="Tanggal" value="<?php echo $insert_date ?>" <?php echo $disabled ?>> </div>
                                <?php echo form_error('insert_date') ?>
                            </div>
                            <div class="form-group">
                                <label> Nama</label>
                                <div class="input-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="is_closed" id="is_closed" class="form-control" placeholder="Status" value="<?php echo $is_closed ?>" <?php echo $disabled ?>> </div>
                                <?php echo form_error('is_closed') ?>
                            </div>
...
<script>
    function back() {
        window.location.href = "<?php echo base_url() ?>index.php/Emergency";
    }
</script>