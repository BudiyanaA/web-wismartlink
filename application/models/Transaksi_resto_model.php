...
class Transaksi_resto_model extends CI_Model
{
	var $infra = null;
	var $table = 'transaksi_order_makan'; //nama tabel dari database
	var $table2 = 'transaksi_order_makan'; //nama tabel dari database
	...
	{
        $this->db->select('*');
        $this->db->from('transaksi_order_makan rm');
