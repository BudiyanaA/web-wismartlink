...
{
	var $infra = null;
	var $table = 'barcode'; //nama tabel dari database
	var $table2 = 'barcode'; //nama tabel dari database
	...
	private function _get_datatables_query()
	{
		...
		// $this->db->select('*');
		$this->db->select('rm.id, rm.info, rm.qrcode, rm.qrimage, rm.keterangan');
		$this->db->from('barcode rm');
